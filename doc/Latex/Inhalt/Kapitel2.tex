...
\begin{figure}[H]
\centering
%%\includegraphics[width=0.8\textwidth]{network_ex1.png}
...
\begin{figure}[H]
\centering
%%\includegraphics[width=0.5\textwidth]{network_ex2.png}
...
Realsisiert wurde das System auf einem Virtuellen VMWare Server mit dem Betriebsystem OpenSuse (Linux). Als Webserver diente Apache 2 in Verbindung mit PHP 5.3.2. Die PHP Version wurde speziell mit einer Oracle Datenbank Anbindung kompiliert.
...
//Ausleseprogramm
java (open jdk/sun vm)
-Start -> switchs per XML, keine Parameter 
-db config
