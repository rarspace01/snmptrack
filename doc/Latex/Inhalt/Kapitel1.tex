...
Bei diesem System, wie bei allen anderen dateibasierenden DBMS, steht meist die einfache Konfigurierbarkeit im Vordergrund. Die dateibasierenden Datenbanken sind meist für einen Einzeluser-Betrieb ausgelegt und spielen hier auch ihre Stärken aus.
...
Im Gegensatz zu MS-SQL verwendet MySQL das GPL Lizenzmodell, sodass die Datenbank für Privatanwender kostenlos ist und die Lizenzgebühren für Unternehmen einen Bruchteil der Kosten ausmachen, die für ein Microsoft System bezahlt werden müssten.\footnote{vgl. http://www.mindfactory.de/product\_info.php/info/p700694 - Aufruf der Seite: 06.02.2011}

Eine weitere Datenbank stellt PostgreSQL dar, welches unter der PostgreSQL-Lizenz zur Verfügung gestellt wird und somit auch für kommerzielle Projekte ohne Kosten nutzbar ist.\footnote{vgl. PostgreSQL: Lizenz, http://www.postgresql.org/about/licence - Aufruf der Seite: 06.02.2011}\footnote{vgl. Eisentraut, P./Helmle, B. (2010), S. 277}
...
Die Anforderungen für die 2. bis 5. Normalform sind jeweils unterschiedlich unt der Literatur zu entnehmen.\footnote{vgl. Schubert, M. (2007), S. 293-307}
...
Beispielsweise sind die Klassen \textit{PKW} und \textit{LKW} Unterklassen von der Klasse \textit{Fahrzeuge}. In Abbildung \ref{fig:uml_class} ist ein Beispiel eines verinfachten Klassendiagramms zu sehen.\\
\\
\begin{figure}[H]
\centering
...
Die Hersteller, welche sich jeweils hinter der Herstellerkennung verbergen, sind öffentlich bei der IEEE einsehbar, z.B. per Internet.\footnote{vgl. OUIs, http://standards.ieee.org/develop/regauth/oui/public.html - Aufruf der Seite: 07.02.2011}
...
Der Agent erhält die Anfragen auf Port 161, während der Manager auf Port 162 die Trap-Meldungen empfängt.\footnote{vgl. Olbrich, A. (2003), S. 295}\\
