...
public class JMain {
	...
	public static void main(String[] args) {
			...
			for(int y=0;y<yMax;y++)
			{
				...
				SNMPThread t=new SNMPThread("Thread Nr. "+y, jm1.snmp,jm1 ,targetAddress, iMax);
...
class SNMPThread implements Runnable {
	Thread runner;
	...
	int iMax;
	  ...
	  public SNMPThread(String threadName, Snmp snmp, JMain jm, Address adr, int iMax) {
