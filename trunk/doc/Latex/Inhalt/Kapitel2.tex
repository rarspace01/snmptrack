...
Im letzten Teil des Auslesevorgangs werden wie in Abbildung X zu erkennen die Hosts erfasst.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{activity_diagram_switch_thread_02.png}
