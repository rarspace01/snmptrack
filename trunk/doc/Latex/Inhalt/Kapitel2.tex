...
Die nächste Schnittstelle ist die Kommunikation mit den Switches per SNMP. Um nicht die komplette SNMP-Kommnuikation selbst in per UDP implmentieren zu müssen emfiehlt es sich hierbei eien bereits vorhandene API zu nutzen.\\
