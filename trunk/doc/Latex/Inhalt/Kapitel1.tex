...
Durch eine nicht benötige Redundanz kommt es zu Integritäts- und Platzverlusten innerhalb der Datenbank.\footnote{vgl. King, T./Reese, G./Yarger, R. (2002), S. 137}
Da ein Wert an mehreren Stellen in der Datenbank steht, kann es zu Problemen bei der Aktualisierung und Löschungen kommen, da alle Werte in der Datenbank geändert werden müssten und nicht nur ein Wert.\footnote{vgl. Eickler, A./Kemper, A. (2006), S. 174f.}
...
Hierzu stehen bis zu fünf Stufen der Normalformen zur Verfügung.\footnote{vgl. Dietrich, M./Ussar M. (2007), S. 98}
...
In der ersten Normalform wird untersucht, ob jedes Attribut atomare Werte besitzt, dass heißt es enthält nur einen Wert und ist frei von Wiederholungen.\footnote{vgl. Schubert, M. (2007), S. 293} \footnote{vgl. Preiß, N. (2007), S. 71f.}
...
Der Nachteil liegt darin, dass nur eine sequentielle Abarbeitung möglich ist und somit die Art der Abfragen mehr oder weniger schon im Voraus bestimmt sein muss.\footnote{vgl. Heuer, A./Saake, G./Sattler, K. (2005), S. 242}
...
So wird dieses von Seiten wie Wikipedia\footnote{vgl. Gilmore, J. (2010), S. 484} oder
...
Aktuell haben sich folgende Sprachen etabliert:\footnote{vgl. Tiobe Software, (2011)}
...
Beim Entwurfsprozess geht es um die Planung der Software-Lösung. Zur Planung von dieser werden unterschiedliche Sprachen zur Modellierung verwendet. Die wichtigste Sprache hierbei ist UML, welche unter anderem auch die Modellierung von Klassen und Objekten, sowie deren Beziehungen untereinander ermöglicht. Auf UML wird in Kapitel \ref{sec:uml} detailliert eingegangen.\footnote{vgl. Pilone, D. (2003), S. 5}
...
Das erste verwendete Diagramm, ist das Anwendungsfalldiagramm (im Folgenden als Usecase-Diagramm benannt).\footnote{vgl. Bremer, S./Oestereich, B. (2009), S. 245f.} 
...
Beispielsweise sind die Klassen \textit{PKW} und \textit{LKW} Unterklassen von der Klasse \textit{Fahrzeuge}. In Abbildung \ref{fig:uml_class} ist ein Beispiel eines Klassendiagramms zu sehen.\\
\\
\begin{figure}[H]
\centering
